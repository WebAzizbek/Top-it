    ...
    <div class="product">
        <div class="container">
            <div class="product__top-nav">
                ...
                <p class="product__top-nav-text">{{ pr?.data.name }}</p>
            </div>
            <div class="product__hero">
                <h2 class="product__hero-title">{{ pr?.data.name }}</h2>
                <ul class="product__hero-list">
                    <!-- ITEM 1 -->
                    <li class="product__hero-item-one">
                        <div class="product__hero-item-small-img-wrapper">
                            <div @click="updateImg(i)" class="product__hero-item-small-item" v-for="(item, i) in pr?.data.images" :key="i">
                                <img class="product__hero-item-small-img" :src="item" alt="" width="66" height="66">
                            </div>
                        </div>
                        <div class="product__hero-item-img-wrapper">
                                <img class="product__hero-item-img" :src="pr?.data.images[iImage]" alt="hero-img" width="544"
                                    height="544">
                            </div>
                    </li>
                    <!-- ITEM 2 -->
                    <div class="product__hero-item-wrapper-two-three">
                        <li class="product__hero-item-two">
                        <div class="product__hero-item-two-top">
                            <div class="product__hero-item-two-top-purple">
                                -50%
                            </div>
                            <div class="product__hero-item-two-top-red">
                                новый
                            </div>
                        </div>
                        <div class="product__hero-item-two-color-wrapper">
                            <p class="product__hero-item-two-color-title">Цвет</p>
                            <ul class="product__hero-item-two-color-list">
                                <li class="product__hero-item-two-color-item"></li>
                                <li class="product__hero-item-two-color-item"></li>
                                <li class="product__hero-item-two-color-item"></li>
                                <li class="product__hero-item-two-color-item"></li>
                            </ul>
                        </div>
                        <div class="product__hero-item-two-character">
                            <h2 class="product__hero-item-two-character-title">Основные характеристики</h2>
                            <ul class="product__hero-item-two-character-list">
                                <li class="product__hero-item-two-character-item" v-for="item in 10" :key="item">
                                    <h3>Бренд:</h3> <h4>{{ pr?.data.brandName }}</h4>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <!-- ITEM 3 -->
                    <li class="product__hero-item-three">
                        <div class="product__hero-item-three__top">
                            <h2 class="product__hero-item-three-old-price">
                               {{ pr?.data.price * 1.5 }}cум
                            </h2>
                            <h3 class="product__hero-item-three-price">{{ pr?.data.price }}cум</h3>
                            <div class="interest__btn-wrapper product__hero-item-three-btn-wrapper">
                                <button class="interest__btn site-btn product__hero-item-three-btn-one">
                                ...
                                <div class="interest__balance product__hero-item-three-btn-two">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#626364" stroke="#CCD2E3" stroke-width="0.6" />
                                    </svg>
    
                                </div>
                            </div>
                            <p class="product__hero-item-three-credit-text">Рассрочка: от {{ (pr?.data.price / 12).toFixed() }} cум в мес.
                            </p>
                            <p class="product__hero-item-three-credit-btn">Купить в рассрочку</p>
                        </div>
                        <ul class="product__hero-item-three-list">
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/money.png"
                                    alt="money" width="24" height="16">
                                <p class="product__hero-item-three-item-text">Купить Смартфоны по перечислению</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/cash.png" alt="money"
                                    width="24" height="20">
                                <p class="product__hero-item-three-item-text">Способы оплаты товара: HUMO, UzCard, терминал,
                                    перечисление, наличные</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/box.png" alt="money"
                                    width="23" height="24">
                                <p class="product__hero-item-three-item-text">Способы получения:
                                    самовывоз, доставка</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/lotmoney.png"
                                    alt="money" width="24" height="20">
                                <p class="product__hero-item-three-item-text">Бонусная система с кэшбеком</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/money.png"
                                    alt="money" width="24" height="16">
                                <p class="product__hero-item-three-item-text">Гарантия и условия возврата</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/save.png"
                                    alt="money" width="20" height="24">
                                <p class="product__hero-item-three-item-text">Гарантия и условия возврата</p>
                            </li>
                            <li class="product__hero-item-three-item">
                                <img class="product__hero-item-three-item-img" src="~/assets/image/png/truck.png"
                                    alt="money" width="25" height="25">
                                <p class="product__hero-item-three-item-text">Доставка: по Ташкенту "до этажа"</p>
                            </li>
                        </ul>
                    </li>
                    </div>
            ...
            <div class="product__bottom">
                <div class="product__bottom-nav">
                    <div class="product__bottom-nav-item">Характеристики</div>
                    <div class="product__bottom-nav-item">Описание товара</div>
                    <div class="product__bottom-nav-item">Наличие в магазинах</div>
                    <div class="product__bottom-nav-item">Отзывы покупателей</div>
                    <div class="product__bottom-nav-item">Обзор модели</div>
                </div>
                <ul class="product__bottom-list">
                    <li class="product__bottom-item">
                        <p class="product__bottom-item-title">Основные характеристики товара</p>
                        <div class="product__bottom-item-text-wrapper" v-for="item in 10" :key="item">
                            <h3>Бренд:</h3> <h4>{{ pr?.data.brandName }}</h4>
                        </div>
                    </li>
                    <li class="product__bottom-item">
                        <p class="product__bottom-item-title">Экран</p>
                        <div class="product__bottom-item-text-wrapper" v-for="item in 8" :key="item">
                            <h3>Тип экрана</h3> <h4>{{ pr?.data.subCategory }}</h4>
                        </div>
                    </li>
                    <li class="product__bottom-item">
                        <p class="product__bottom-item-title">Мультимедийные возможности</p>
                        <div class="product__bottom-item-text-wrapper" v-for="item in 11" :key="item">
                            <h3>Тип экрана</h3> <h4>{{ pr?.data.category }}</h4>
                        </div>
                    </li>
                    <li class="product__bottom-item">
                        <p class="product__bottom-item-title">Связь</p>
                        <div class="product__bottom-item-text-wrapper" v-for="item in 8" :key="item">
                            <h3>Поддержка стандартов</h3> <h4>{{ pr?.data.code }}</h4>
                        </div>
                    </li>
                </ul>
            </div>
...
const { data: pr } = useLazyAsyncData('product', () => $fetch(config.baseUrl + '/product-manager/product/detail?key=' + route.params.slug))
const iImage = ref(0)
